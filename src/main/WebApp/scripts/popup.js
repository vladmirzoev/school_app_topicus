...
function enableSubmit() {
    ...
    const tel = document.getElementById("telephone1")
    let isValid = true
    for (let i = 0; i < inputs.length; i++) {
        ...
        if (changedInput.value.trim() === "" || changedInput.value === null) {
            ...
            document.getElementById("message1").innerHTML = "*Insert a valid phone number*"
            isValid = false
            break
...
function enableSubmit2() {
    ...
    const tel = document.getElementById("p_no1")
    ...
    for (var i = 0; i < inputs.length; i++) {
        ...
        if (changedInput.value.trim() === "" || changedInput.value === null) {
            ...
            document.getElementById("message2").innerHTML = "*Insert a valid phone number*"
            isValid = false
            break
...
function enableSubmit5() {
    ...
    for (var i = 0; i < inputs.length; i++) {
        ...
        if (changedInput.value === null || changedInput.value.trim() === "" || !changedInput.value) {
            document.getElementById("message2").innerHTML = "*Fill in all the required information*"
            isValid = false
            break
        } else {
